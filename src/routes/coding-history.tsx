    ...
    <AppShell>
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="rounded-2xl border border-border bg-card overflow-hidden">
          <div className="grid grid-cols-[1fr_120px_120px_120px_140px] px-5 py-3 text-sm font-semibold text-muted-foreground border-b border-border">
            <div>Date</div>
            <div>Solved</div>
            <div>Coins</div>
            <div>Status</div>
          ...
          {history.map((h, i) => {
            ...
            return (
              <div key={i} className="border-b border-border last:border-0">
                <div className="grid grid-cols-[1fr_120px_120px_120px_140px] px-5 py-4 items-center hover:bg-muted/50">
                      ...
                      {h.problems.map((p) => (
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            <span className={`text-[10px] font-bold uppercase px-2 py-1 rounded ${diffClass(p.difficulty)}`}>
                              {p.difficulty}
                            </span>
